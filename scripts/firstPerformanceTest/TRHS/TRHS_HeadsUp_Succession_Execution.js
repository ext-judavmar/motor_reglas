...
import { executionCases } from '../../../testdata/TRHS/TRHS_HeadsUp_Succession_testdata.js';
...
const SCRIPT_NAME = 'TRHS_HeadsUp_Succession_Execution';
...
export default function () {
  ...
  const url     = `${BASE_URL}/reglas/bulk/env-test/headsup-succession/global-smu-prod`;
