...
import { executionCases } from '../../../testdata/TRMA/TRMA_Marcas_testdata.js';
...
const SCRIPT_NAME = 'TRMA_Marcas_Execution';
...
export default function () {
  ...
  const url     = `${BASE_URL}/reglas/bulk/env-test/marcas/global-smu-prod`;
