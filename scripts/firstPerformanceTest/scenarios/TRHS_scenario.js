...
import { executionCases, intApiCases } from '../../../testdata/TRHS/TRHS_HeadsUp_Succession_testdata.js';
import { eligibleUsers } from '../../../generalfunctions/csvdata.js';

const EXEC_URL    = `${__ENV.BASE_URL    || 'https://test--fps-rule-engine.furyapps.io'}/reglas/bulk/env-test/headsup-succession/global-smu-prod`;
...
const SCRIPT_NAME = 'TRHS_scenario';
