...
import { executionCases, intApiCases } from '../../../testdata/TRMA/TRMA_Marcas_testdata.js';
import { eligibleUsers } from '../../../generalfunctions/csvdata.js';

const EXEC_URL    = `${__ENV.BASE_URL    || 'https://test--fps-rule-engine.furyapps.io'}/reglas/bulk/env-test/marcas/global-smu-prod`;
...
const SCRIPT_NAME = 'TRMA_scenario';
